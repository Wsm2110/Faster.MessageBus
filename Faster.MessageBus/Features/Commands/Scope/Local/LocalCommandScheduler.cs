...
/// </summary>
public sealed class LocalCommandScheduler : ICommandScheduler, IDisposable
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="LocalCommandScheduler"/> class.
    ...
    public LocalCommandScheduler(string name = "LocalCommandSchedulerThread")
    {
