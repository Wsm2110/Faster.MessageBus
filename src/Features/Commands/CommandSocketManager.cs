...
//    /// </summary>
//    private  async void HandleAddSocket(MeshContext context)
//    {
...
//        var socketArray = new CommandClient[context.Hosts == 0 ? 1 : context.Hosts];
...
//            await socket.ConnectAsync(new IPEndPoint(), 5000));
