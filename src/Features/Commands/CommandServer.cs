...
//        _server = new CommandServerSAEA(new IPEndPoint(IPAddress.Any, options.Value.RPCPort), new BufferManager());
//        _server.OnMessage += async (clientId, msg) =>
//        {
//           await server.SendToAsync(clientId, default);
//        };
